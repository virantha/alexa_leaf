...
.. automodule:: alexa_leaf
    :private-members:
"""

class AlexaLeaf(object):
    """
    ...
    def get_options(self, argv):
        ...
        p = argparse.ArgumentParser(
                description = "",
                epilog = "Alexa Leaf version %s (Copyright 2014 Virantha Ekanayake)" % __version__,
                )
    ...
    def go(self, argv):
        """ 
            The main entry point into AlexaLeaf
